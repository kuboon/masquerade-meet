/**
 * The circus troupe: ten performers under the big top.
 *
 ...
 *
 * The voices are spread across the pitch range in one pass so that no two
 * performers can be mistaken for one another. They have not been listened to
