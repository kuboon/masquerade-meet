...
- ルームを作るときに **キャラクターセット** を選びます。ルームに入った参加者は、そのセットの **15 種類のキャラクター** から 1 人を選びます（早い者勝ち、重複なし）
...
- 1 ルームの人数上限は実質 15 人です（1 セットが 15 体のため）。空きキャラクターがない状態で入室した参加者はキャラクターを選べません。
